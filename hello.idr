...
--nonNegFunc: (nn: NonNeg n) -> Divide2 nn nn
--nonNegFunc NNpos = ?nonNegFunc_rhs_1
--nonNegFunc NNzero = ?nonNegFunc_rhs_2

mulProof : Zahlen.mul Main.twoZ Main.twoZ = Main.fourZ
mulProof = Refl

-- div_4_2 : Divide Main.nz_fourZ Main.nz_twoZ {tt = Main.nz_twoZ}
-- div_4_2 =  MkDiv {t = twoZ} nz_fourZ nz_twoZ Refl
